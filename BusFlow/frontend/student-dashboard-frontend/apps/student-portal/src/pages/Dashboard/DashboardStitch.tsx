...
export const DashboardStitch: React.FC = () => {
  ...
  const seedDataIfNeeded = async () => {
    try {
      ...
      await studentApi.seedDemoData();
      console.log('Demo data seeded');
    } catch (error) {
      console.log('Demo data already exists or seeding failed');
    }
    // Then load dashboard
    loadDashboardData();
  };
  ...
  const loadDashboardData = async () => {
    try {
      ...
      console.log('Today bus:', data.todayBus);
  ...
  console.log('Bus data:', {
    todayBus,
    busesForMapLength: busesForMap.length,
    hasCurrentLocation: !!todayBus?.currentLocation,
  });
